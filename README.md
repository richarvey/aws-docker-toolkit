## AWS Toolkit - [![build](https://github.com/WAOptics/aws-docker-toolkit/actions/workflows/main.yml/badge.svg)](https://github.com/WAOptics/aws-docker-toolkit/actions/workflows/main.yml)

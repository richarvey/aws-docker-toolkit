...
#    docker push "richarvey/awscli:${VERSION}"
    ...
    docker buildx build --platform linux/amd64,linux/arm64 -t "richarvey/awscli:${VERSION}" --push .
...
#    docker push "richarvey/awscli:${VERSION}-slim"
    ...
    docker buildx build --platform linux/amd64,linux/arm64 -t "richarvey/awscli:${VERSION}-slim" -f Dockerfile-slim --push .
